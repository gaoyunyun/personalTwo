        ...
        var j = function(e) {
            ...
            function ua(a) {
                ...
                for (c = i.length; b < c; b++)
                    for (f = i[b].firstChild; f;) g = f.nodeName.toUpperCase(), ("TD" == g || "TH" == g) && d.push(f), f = f.nextSibling;
                c = 0;
                    ...
                    a.aiDisplayMaster.sort(function(a, b) {
                        ...
                        for (c = 0; c < r; c++) {
                            ...
                            for (e = f.length; d < e; d++)
                                if (i = q[f[d]].sType, i = p[(i ? i : "string") + "-" + o[c][1]](l[a]._aSortData[f[d]], l[b]._aSortData[f[d]]), 0 !== i) return i
                        }
